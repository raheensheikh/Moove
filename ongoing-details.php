...
<section class="content-section profile_sec">
    <div class="row bgWhite mt-5">
        <h5 class="title mb-3">
            ...
            <span>Ongoing Booking Detail</span>
        </h5>
        <div class="col-12 col-md-10 col-lg-10 col-xl-6 mb-3">
            <div class="booking_details serviceDetail mb-3">
                <div class="scroll">
                    ...
                    <div class="box_bottom mt-3">
                        <h6 class="box_title mb-2">Mover Status</h6>
                        <a href="#" class="cta cta2">On The Way to Pickup</a>
                    </div>
